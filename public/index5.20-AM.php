<?php require_once('Connections/dw_UseCaseConnection.php'); ?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO usecaseinfo (useCaseName, version, subVersion, `first`, `last`, email, first2, last2, email2, goal, summary, primaryActor, primaryActorRole, otherPrimaryActors, secondaryActors, preconditions, triggers, basicFlow, alternateFlow, postconditions, notes, diagram) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['diagram'], "text"));
...
<link href="notesStyle.css" rel="stylesheet" type="text/css">
<link href="fieldFormat.css" rel="stylesheet" type="text/css">
<head>
...
<p><span class="FieldFormat">
  <label for="first2">First Name POC1:</label>
  </span>
  <input type="text" name="first" id="first2" />
</p>
  <div class="header"><a href="#"><a href="#"><img src="images/bisonbannerCropped.png" width="718" height="71" alt="bisonPhoto" style="background-color:#960 /></a><a href="#"></a><img src="" alt="Insert Logo Here" name="Insert_logo" width="180" height="90" id="Insert_logo" style="background-color: #C6D580; display:inline;" /><a href="#"></a><!-- end .header --></div>
  <div class="content">
